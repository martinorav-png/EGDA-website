        ...
        <header className="sticky top-0 z-50 solid-bg brutalist-border-b">
          ...
          <div className="grid grid-cols-12 relative">
            ...
            <div className="col-span-6 md:col-span-1 flex items-center justify-center p-4 interactive-cell">
              <a href="https://discord.com/invite/PQHK5NN2fd" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 w-full h-full justify-center">
        ...
        <footer className="solid-bg brutalist-border-t p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
            ...
            <div className="flex flex-col md:items-end justify-end space-y-4">
              ...
              <a href="https://discord.com/invite/PQHK5NN2fd" target="_blank" rel="noopener noreferrer" className="text-xl font-bold uppercase tracking-tight hover:underline underline-offset-4 decoration-2 flex items-center gap-2">
                Join Discord Hub
