...
const PixelBlast = ({
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const target = container.closest('.hero-ps1') || renderer.domElement;
      ...
      const animate = () => {
        ...
        if (composer) {
          ...
          composer.passes.forEach((p) => {
            ...
            if (effects) effects.forEach((eff) => {
      ...
      threeRef.current = { renderer, scene, camera, material, clock, clickIx: 0, uniforms, resizeObserver: ro, raf, quad, composer, touch, liquidEffect, eventTarget: target, onPointerDown, onPointerMove };
    } else {
      const t = threeRef.current;
